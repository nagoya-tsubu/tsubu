 ...
 *
 */
public class GaoooohActivity extends Activity {
	...
	private static final String	GAOH_STRING = "(「・ω・)「がおー";		//(「・ω・)「がおー
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if((null != action) && (true == ACTION_INTERCEPT.equals(action))) {
        	//simejiから呼び出されたとき、未確定文字列の後に「 (「・ω・)「がおー 」を
        	//追加する
